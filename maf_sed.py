...
input_size      = train_dataloader.dataset.tensors[0].input_size.shape[1]
cond_label_size = train_dataloader.dataset.tensors[1].input_size.shape[1]
...
def train_and_evaluate(model, train_loader, valid_loader, optimizer):
    ...
    for i in range(1000):
        ...
        eval_logprob, _ = evaluate(model, valid_loader, i, args)
